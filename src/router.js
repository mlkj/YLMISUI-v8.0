...
import Router from 'vue-router';
    ...
    //物资系统---消耗物资管理
        ...
        // const MonthStore = resolve => require(['./pages/materials/monthstore/MonthStore.vue'], resolve);
     //成本分析-- 消耗物资成本分析
    ...
    // //周转材料管理--摊销管理
        ...
        const TurnoverMonthStore = resolve => require(['./pages/materials/turnovermonthstore/MonthStore.vue'], resolve);
    ...
    //业务组件    Api测试
      ...
      children: [
       //消耗物资管理
        ...
        // { path: 'monthstore', component: MonthStore, name: '材料动态表'  },
    //周转材料管理--摊销管理
        ...
        { path: 'turnovermonthstore', component: TurnoverMonthStore, name: '周转材料动态表'  },
    // //半成品管理--钢筋加工管理
