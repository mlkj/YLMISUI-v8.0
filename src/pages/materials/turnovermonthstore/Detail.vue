                    ...
                    get () {
                        return {
                            ...
                            columns:[ {attr: { prop: 'infoName', label: '材料名称', width:100,  } },
                                        ...
                                        {attr: { prop: 'bookPrice', label: '原始单价', width:100,  } },
                                        {attr: { prop: 'quantity', label: '原始数量', width:120,  } },
                                        {attr: { prop: 'bookOriginalValue', label: '原值', width:120,  } },
                                        {attr: { prop: 'lastQuantity', label: '上期结存数量', width:120,  } },
                                        {attr: { prop: 'lastSum', label: '上期结存金额', width:120,  } },
                                        ...
                                        {attr: { prop: 'currAmoSum', label: '本期摊销金额', width:120,  } },
                                        {attr: { prop: 'currAlQuantity', label: '本期调出数量', width:120,  } },
                                        {attr: { prop: 'currAlSum', label: '本期调出金额', width:120,  } },
                                        {attr: { prop: 'currScpQuantity', label: '本期报废数量', width:120,  } },
                                        {attr: { prop: 'currScpSum', label: '本期报废金额', width:120,  } },
                                        {attr: { prop: 'currSellSum', label: '本期让售金额', width:120,  } },
    ...
    methods:{
        _getReportList(){
            ...
            params= {
                ...
                procName:'Report_TurnoverMaterialDymaticDetails'
            };
            //执行通用存储过程获取表格数据
